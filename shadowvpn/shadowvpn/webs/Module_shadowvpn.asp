...
function version_show() {
	...
	$.ajax({
		url: 'https://raw.githubusercontent.com/paldier/softcenterarm/master/shadowvpn/config.json.js',
		type: 'GET',
...
<body onload="init();">
	...
	<input type="hidden" name="action_script" value="shadowvpn.sh"/>
										...
										<div class="formfontdesc" id="cmdDesc"></div>
											...
											<table style="margin:-1px 0px 0px 0px;" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable" id="ShadowVPN_detail_table">
												...
												<tr>
													<th width="35%">路由文件</th>
													<td>
														<input type="text" class="input_ss_table" style="width:auto; display:none;" size="45" id="shadowvpn_file" name="shadowvpn_file" maxlength="50" placeholder="请输入绝对文件路径" value="/jffs/softcenter/dw/cnn.txt" />	<span class='software_action'><font color='#ffcc00'>全局模式无需设置</font></span>
													</td>
												</tr>
												<tr>
