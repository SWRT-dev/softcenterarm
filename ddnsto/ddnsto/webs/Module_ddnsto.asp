...
function version_show() {
	$.ajax({
		url: 'https://sc.softcenter.site/arm64/ddnsto/config.json.js',
		type: 'GET',
		dataType: 'jsonp',
...
<a type="button" class="rog_btn" style="cursor:pointer" href="https://doc.linkease.com/zh/guide/ddnsto/" target="_blank">如何获取令牌?</a>
 <!-- <a type="button" class="rog_btn" style="cursor:pointer" onclick="openShutManager(this,'NoteBox',false,'关闭使用说明','如何获取令牌') "
										...
										<div id="NoteBox" style="display:none">
											...
											<li>穿透教程：<a id="gfw_number" href="https://doc.linkease.com/zh/guide/ddnsto/start.html" target="_blank"><i>DDNSTO远程控制使用教程</i></a></li>
										</div>
									</td>
								</tr>
							</table>
