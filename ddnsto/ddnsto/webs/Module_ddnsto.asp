...
function get_status() {
    $.ajax({
        url: 'applydb.cgi?current_page=Module_ddnsto.asp&next_page=Module_ddnsto.asp&group_id=&modified=0&action_mode=+Refresh+&action_script=ddnsto_status.sh&action_wait=&first_time=&preferred_lang=CN',
        dataType: 'html',
        error: function(xhr) {
            alert("error");
        },
...
function updateOptions() {
    ...
    document.form.action_script.value = "ddnsto_config.sh";
...
function notice_show(){
    $.ajax({
        url: 'https://scarm.paldier.com/ddnsto/push_message.json.js',
        type: 'GET',
        dataType: 'jsonp',
