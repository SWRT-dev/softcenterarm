...
if [ "$fastd1ck_protocal" == "300" ];then
	# protocal 300
	packageName='com.xunlei.vip.swjsq'
	protocolVersion=300
	businessType=68
	sdkVersion='3.1.2.185150'
	clientVersion='2.7.2.0'
	agent_xl="android-ok-http-client/xl-acc-sdk/version-$sdkVersion"
	agent_down='okhttp/3.9.1'
	agent_up='android-async-http/xl-acc-sdk/version-1.0.0.1'
	client_type_down='android-swjsq'
	client_type_up='android-uplink'
elif [ "$fastd1ck_protocal" == "200" ];then
# protocal 200
	packageName='com.xunlei.vip.swjsq'
	protocolVersion=200
	businessType=68
	sdkVersion='2.1.1.177662'
	clientVersion='2.4.1.3'
	agent_xl="android-async-http/xl-acc-sdk/version-$sdkVersion"
	agent_down='okhttp/3.4.1'
	agent_up='android-async-http/xl-acc-sdk/version-1.0.0.1'
	client_type_down='android-swjsq'
	client_type_up='android-uplink'
...
xlnetacc_init() {
	...
	logging=$fastd1ck_logging
	verbose=$fastd1ck_logging_v
	network=$fastd1ck_if
	keepalive=$fastd1ck_keepalive
	relogin=$fastd1ck_relogin
	username=$fastd1ck_user
	password=$fastd1ck_passwd
	...
	# 生成设备标识
	_devicesign=$fastd1ck_device_sign
	_peerid=$fastd1ck_peerid
